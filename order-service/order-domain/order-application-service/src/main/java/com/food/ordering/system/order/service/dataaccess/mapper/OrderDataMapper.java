...
import com.food.ordering.system.order.service.dataaccess.entity.OrderItem;
...
import com.food.ordering.system.order.service.dataaccess.valueobject.StreetAddress;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(List<com.food.ordering.system.order.service.dataaccess.dto.create.OrderItem> orderItems) {
        return orderItems
                .stream()
                .map(orderItem ->
                       OrderItem.builder()
