...
import com.food.ordering.system.order.service.application.valueobject.OrderItemId;
import com.food.ordering.system.order.service.application.valueobject.StreetAddress;
    ...
    private void validateItemPrice(OrderItem orderItem) {
        if(!orderItem.isPriceValid()){
            throw new OrderDomainException("Order Item Price : " + orderItem.getPrice().getAmount()
                    + " is not valid for Product " + orderItem.getProducts().getId().getValue());
        }
    }
