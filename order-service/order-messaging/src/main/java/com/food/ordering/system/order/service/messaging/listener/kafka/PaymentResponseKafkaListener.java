...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public void receive(@Payload List<PaymentResponseAvroModel> messages,
                        ...
                        @Header(KafkaHeaders.RECEIVED_TOPIC) List<Integer> partitions,
                        @Header(KafkaHeaders.OFFSET) List<Integer> offsets) {
        log.info("{} number of payment responses received with key:{}, partition:{} and offset:{}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString());
        messages.forEach(paymentResponseAvroModel -> {
            ...
            PaymentStatus.FAILED ==paymentResponseAvroModel.getPaymentStatus()) {
                ...
                paymentResponseMessageListener.paymentCanceled(orderMessagingDataMapper.paymentResponseAvroModelToPaymentResponse(paymentResponseAvroModel));
            }
        });
