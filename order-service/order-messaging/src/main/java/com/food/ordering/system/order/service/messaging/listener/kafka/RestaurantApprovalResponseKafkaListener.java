    ...
    public void receive(
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if(OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()){
                log.info("Processing approved order for order id:{}", restaurantApprovalResponseAvroModel.getId());
                ...
                log.info("Processing rejected order for order id:{}, with messages {}", restaurantApprovalResponseAvroModel.getId(),
